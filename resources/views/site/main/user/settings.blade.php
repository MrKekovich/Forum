                ...
                <div class="card">
                    ...
                    <div class="card-body tab-content">
                        <div class="tab-pane active" id="profile">
                            ...
                            <hr>
                            <form action="{{ route('settings.update', auth('web')->user()->id) }}" method="post">
                                @csrf
                                @method('PATCH')
...
{{--                                </div>--}}
                                <div class="form-group">
                                    ...
                                    @error('profile_pic') <p class="d-inline-block text-danger">*{{ $message }}</p> @enderror
                                    <input type="text" class="form-control" name="profile_pic" id="url" placeholder="https://i.imgur.com/example.jpg"
                                           value="{{ auth('web')->user()->profile_pic }}">
                                </div>
                                {{--                                <div class="form-group">--}}
...
{{--                                </div>--}}
                                ...
                                <div class="mt-2">
                                    <img src="{{ auth('web')->user()->profile_pic }}" alt="current picture" class="rounded-circle"
                                         width="100"
                                         onerror="this.onerror=null; this.src='https://i.imgur.com/4q8VYRe.png'"> - current profile picture
                                </div>
                            </form>
                        </div>
